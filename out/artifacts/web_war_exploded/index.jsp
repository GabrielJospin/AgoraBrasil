...
<%@ page contentType="text/html;charset=ISO-8859-1" language="java" import="Config.*" %>
<%@ page import="Item.Card" %>
<%@ page import="Item.ListaCard" %>
